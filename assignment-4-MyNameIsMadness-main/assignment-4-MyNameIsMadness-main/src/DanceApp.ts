...
{ 
    ...
    loadAnimations(): void
    {
        ...
        this.balletDanceMotions.push(this.balletAnt.loadMotionClip('./assets/data/05_15.amc'));
        this.balletDanceMotions.push(this.balletAnt.loadMotionClip('./assets/data/05_19.amc'));
        this.balletDanceMotions.push(this.balletAnt.loadMotionClip('./assets/data/05_13.amc'));
        this.balletDanceMotions.push(this.balletAnt.loadMotionClip('./assets/data/05_04.amc'));
    ...
    startAnimations(): void
    {
        ...
        this.balletDanceMotions[1].trimFront(25);
        this.balletDanceMotions[1].trimBack(60);

        this.balletDanceMotions[2].trimFront(20);
        this.balletDanceMotions[2].trimBack(20);

        this.balletDanceMotions[3].trimFront(50);
        this.balletDanceMotions[3].trimBack(15);

        this.balletDanceMotions[4].trimFront(200);
        this.balletDanceMotions[4].trimBack(50);
